...
export default class Server {
  async fetch(method: string, url: URL | string, options?: ServerOptions) {
    let current_url = options?.baseURL ? options.baseURL + url : url
    // 判断 get
    ...
    // 判断 post
    if ((method.toLowerCase() === 'post' || method.toLowerCase() === 'put') && options?.data) {
